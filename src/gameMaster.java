...
public class gameMaster {
	...
	//get the player's play mode choice (either be battle and catch or just catch mode)
	...
	//dynamically generate the menu UI
	...
	//choose pokemon from the list generated by the generatePokemon method
